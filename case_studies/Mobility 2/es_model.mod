...
var Shares_mobility_passenger {TECHNOLOGIES_OF_END_USES_CATEGORY["MOBILITY_PASSENGER_SD"]} >=0; # %_PassMob [-]: Constant share of passenger mobility
...
subject to operating_strategy_mob_passenger{j in TECHNOLOGIES_OF_END_USES_CATEGORY["MOBILITY_PASSENGER_SD"], h in HOURS, td in TYPICAL_DAYS}:
